    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $(document).ready(function() {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'เกิดข้อผิดพลาด Username หรือ Password ผิดคุบบ!',
            })     
        });            
    ...
    <div class="container">
        ...
        <form method="post" action="index.php">
            ...
            <button type="submit" name="login" class="Button">
                <span class="Button__inner"> เข้าสู่ระบบ </span>
            </button>

            
        </form>
        <p>ถ้ายังไม่มี Username <a href="register.php">สมัคร กดตรงนี้</a> 
